...
BASEDIR=$2 # Path to the base directory where output files will be written to a subdirectory named "angsd/"
...
EXTRA_ARG=${12:-'-remove_bads 1 -only_proper_pairs 1 -trim 0'} # Extra arguments when running ANGSD
