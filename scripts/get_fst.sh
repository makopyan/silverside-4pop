...
REALSFS=${5:-/programs/angsd-0.940/misc/realSFS} # Path to the realSFS module in ANGSD. Default value is /workdir/programs/angsd0.935/angsd/misc/realSFS
THREADS=${6:-28} # Number of parallel threads to use, default value is 28.
